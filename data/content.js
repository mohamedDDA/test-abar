  ...
  pages: {
    ...
    quality: {
      ...
      ar: {
        ...
        , help: "حققت شركة ابار جميع الشروط والمتطلبات للحصول على نظام إدارة الجودة ومنها: – نظام إدارة موثق (دليل – سياسة – إجراءات – نماذج – تعليمات عمل) – الوثائق والسجلات الدورية والسنوية – تصحيح الأخطاء واتخاذ الاجراءات بمنع المشاكل قبل حدوثها اجتياز المراجعة والتدقيق الميداني"
      }
    },
